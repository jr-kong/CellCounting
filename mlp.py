...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train an sklearn MLP regressor for cell counting."
    )
    parser.add_argument(
        "--metadata",
        type=Path,
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[256, 128],
        help="Hidden layer sizes for MLPRegressor.",
    )
    parser.add_argument(
        "--max-iter",
        type=int,
